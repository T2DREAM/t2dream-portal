...
def main():
   ...
   # parser.add_argument('--wale-s3-prefix', default='s3://encoded-backups-prod/production')
    ...
    parser.add_argument(
        '--image-id', default='ami-076e276d85f524150',
        help="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#LaunchInstanceWizard:ami=ami-076e276d85f524150")
    parser.add_argument(
