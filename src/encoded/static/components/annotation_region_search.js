...
var AdvSearch = createReactClass({
    getInitialState: function() {
        return {
            ...
            searchTerm: '',
            coordinates: '',
            genome: annotationGenomes[0].value,
            terms: {}
        };
    },
                            ...
                            <div className="input-group input-group-region-input">
                                ...
                                <div className="input-group-addon input-group-select-addon">
                                    <select value={this.state.genome} name="genome" onChange={this.handleAssemblySelect}>
                                        {annotationGenomes.map(genomeId =>
...
var AnnotationSearch = module.exports.AnnotationSearch = createReactClass({
    onFilter: function(e) {
...
globals.content_views.register(AnnotationSearch, 'annotation_region_search');
