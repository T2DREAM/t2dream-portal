...
var AdvSearch = createReactClass({
    getInitialState: function() {
        return {
            ...
            searchTerm: '',
            coordinates: '',
            genome: epigenomicGenomes[0].value,
            terms: {}
        };
    },
                            ...
                            <div className="input-group input-group-region-input">
                                ...
                                <div className="input-group-addon input-group-select-addon">
                                    <select value={this.state.genome} name="genome" onChange={this.handleAssemblySelect}>
                                        {epigenomicGenomes.map(genomeId =>
...
var EpigenomicSearch = module.exports.EpigenomicSearch = createReactClass({
    onFilter: function(e) {
    ...
    render: function() {
        ...
        return (
            <div>
                <h2>Search epigenomic annotations</h2>
...
globals.content_views.register(EpigenomicSearch, 'epigenomic-search');
